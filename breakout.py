...
class Breakout:
    def __init__(self):
        #set up the game window and initial setting
        self.screen = pygame.display.set_mode(DIMS['SCREEN'])
        pygame.display.set_caption("Breakout Game")
        self.font = pygame.font.Font(None, 36)
        self.db_path = r"/home/bubba/programming/PYPortfolio/highscores.db"
        #Create high scores database if it doesn't exist, or edit to you path
    ...
    def get_high_score(self):
        ...
        try:
            with sqlite3.connect(self.db_path) as con:
                result = con.cursor().execute("SELECT name,score FROM highscores ORDER BY score DESC LIMIT 1").fetchone()
    ...
    def run(self):
        #Handle player nme input screen
    ...
    def game_loop(self):
        ...
        while True:
            ...
            #Handle ball collion with bricks
